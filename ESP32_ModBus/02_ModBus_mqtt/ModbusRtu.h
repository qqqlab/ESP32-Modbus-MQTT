//copied from https://github.com/smarmengol/Modbus-Master-Slave-for-Arduino
//modified: poll() and MAX_BUFFER  250
...
#define T35  5
#define  MAX_BUFFER  250	//!< maximum size for the communication buffer in bytes
